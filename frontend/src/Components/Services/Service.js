            ...
            <div className= "__service-content">
                <div className="d-flex cr">
                    <div className="description text-center">  
                        ...
                        <Link to="/menu" className="btn " role="button">Our menus</Link>
                        <Link to="/decoration" className="btn " role="button">Decoration</Link>
                        <Link to="/photography" className="btn " role="button">Photography</Link>
                        </div>
                    </div>
