...
const Decoration = () =>{
    ...
    return(
            ...
            <div className="banner-photo">
                <br/>
                <h1 className=" mt-3 mb-5 text-center">Photography</h1>
                <Link to="/quotation" className="btn btn-primary mx-auto mt-5 flex-flow w-25" role="button">Request For Booking</Link>
