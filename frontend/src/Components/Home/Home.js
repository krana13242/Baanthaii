        ...
        <section className="pb-5 home">
            <div className="home-content home-section">
                ...
                <div className="bg-opacity-h d-flex flex-column align-items-center">
                    <h1>BAANTHAII</h1>
                    <h3>Full Service Catering House for All Your Catering Needs</h3>
            ...
            <div className="home-service ">
                ...
                <div className="banner-section">
                  ...
                  <Link to="/quotation" className="btn btn-primary mx-auto mt-5 flex-flow" role="button">See Our Menus</Link>
